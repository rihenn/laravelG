...
<body>
    ...
    <tr>
        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
            ...
            color: #F0F0F0;" class="preheader">
                Naeron şifre sıfırlama talebiniz.</div>
            <a target="_blank" style="text-decoration: none;"
                href="https://www.gruparge.com/"><img border="0" vspace="0" hspace="0"
                src="https://www.gruparge.com/wp-content/uploads/2022/07/grup-arge-logo-88.png"
                width="100" height="60"
    ...
    <tr>
        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
            ...
            href="{{route("sifreYenileme")}}{{$url}}" target="_blank" style="text-decoration: underline;">
                <table border="0" cellpadding="0" cellspacing="0" align="center" style="max-width: 240px; min-width: 120px; border-collapse: collapse; border-spacing: 0; padding: 0;"><tr><td align="center" valign="middle" style="padding: 12px 24px; margin: 0; text-decoration: underline; border-collapse: collapse; border-spacing: 0; border-radius: 4px; -webkit-border-radius: 4px; -moz-border-radius: 4px; -khtml-border-radius: 4px;"
                    bgcolor="#009fe3"><a target="_blank" style="text-decoration: underline;
                    color: #FFFFFF; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 120%;"
                    href="{{route("sifreYenileme")}}{{$url}}">
                        ŞİFREMİ SIFIRLA
                    </a>
            </td></tr>
    <!-- PARAGRAPH -->
    ...
    <tr>
        ...
        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%; font-size: 14px; font-weight: 400; line-height: 160%;
            ...
            color: #ff0000;
            font-family: sans-serif;" class="paragraph">
            Talebi siz yapmadıysanız lübu e-postayı dikkate almayın. </br> Endişelenmeyin! Şifreniz ele geçirilmedi veya sıfırlanmadı.
        </td>
    </tr>
    <!-- LINE -->
    <!-- Set line color -->
