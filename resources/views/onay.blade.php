...
<body>
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
            ...
            <div id="formIcon" style="background-color: #f6f6f6;-webkit-border-radius:10px 10px 0 0 ;border-radius:10px 10px 0 0 ;" class="fadeIn first">
                <img src="../img/checked.png" id="icon" alt="User Icon" />
            </div>
                <h3>ŞİFRENİZ GÜNCELLENDİ</h3>
                <p> Sistemimizde yaptığınız işlemlerle şifreniz yenilenmiştir giriş yapmak iççin alttaki butona tıklayabilirsiniz </p>
